...
class DaoStadium
{
    ...
    public function addStadium($stadium): void
    {
        ...
        $pdo = Dao::getConnection();     // Connection to the DB
        $request = $pdo->prepare("INSERT INTO stade (Nom_stade,Adresse,Type_de_terrain,Commentaires) VALUES 
        ('" . $stadium->get_name() . "','" . $stadium->get_adress() . "','" . $stadium->get_groundType() . "','" . $stadium->get_commentary() . "')");  // Prepare the request to be execute
    ...
    public function modifyStadium($stadium): void
    {
        ...
        $request = $pdo->prepare("UPDATE stade SET Nom_stade='" . $stadium->get_name() . "',Adresse='" . $stadium->get_adress() . "',Type_de_terrain
        ='" . $stadium->get_groundType() . "',Commentaires='" . $stadium->get_commentary() . "' WHERE Id_stade=" . $stadium->get_idStadium());  // Prepare the request to be execute
