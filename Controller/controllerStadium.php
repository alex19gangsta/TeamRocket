            ...
            case 'addStadium':
                ...
                if (isset($_POST['Name'])) {
                    ...
                    if (!empty($_POST["Name"]) and !empty($_POST["Adress"])) {  // If an important field is empty
                        ...
                        $newStadium = new Stadium(null, addslashes(htmlspecialchars(ucfirst($_POST["Name"]))), addslashes(htmlspecialchars($_POST["Adress"])),
                         addslashes(htmlspecialchars($_POST["TypeofTerrain"])), addslashes(htmlspecialchars($_POST["Commentary"]))); 
                            // New stadium object with parameters edited in a form from "view/Stadium/formAddStadium.phtml"
