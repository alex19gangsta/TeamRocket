            ...
            case 'modifyMatch':
                ...
                if (isset($_POST['Match'])) {
                    ...
                    if (!empty($_POST["Date"]) and !empty($_POST["Hours"])) {  // If an important field is not empty
                        ...
                        $modMatch =  new Match($idMatch, addslashes(htmlspecialchars($_POST["Hours"])), addslashes(htmlspecialchars($_POST["Date"])), addslashes(htmlspecialchars($_POST["Season"])), addslashes(htmlspecialchars($_POST["Stadium"]))); // New Match object with parameters edited in a form from "view/Match/formModifyMatch.phtml"
